...
class L1Decoder {
	...
	//@{
	volatile float mRSSI;						///< RSSI of this channel, dB wrt full scale, most recent burst
	volatile float mTimingError;				///< Timing error in symbols, most recent burst
	...
	*/
	...
	float timingError() const { mPhyNew=false; return mTimingError; }
...
private:
	...
	unsigned mMaxQSize;		///< vocoder latency limitation
